    ...
    <div class="min-w-[800px] md:w-full p-6 md:p-0">
      ...
      <div class="flex items-center justify-between px-4 py-3 border-t">
        <div class="flex items-center text-sm text-gray-500">
          Showing {(currentPage - 1) * paginatedOrders.length + 1} to {Math.min(currentPage * paginatedOrders.length, inProgressOrders.length)} of {inProgressOrders.length} entries
        </div>
